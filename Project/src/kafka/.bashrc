...
#aliases
alias HDFS='$HADOOP_HOME/bin/hdfs dfs'
alias hbshell="$HBASE_HOME/bin/hbase shell"
alias clearavg="$KAFKA_HOME/bin/kafka-topics.sh --zookeeper localhost:2181 --delete --topic avg"
